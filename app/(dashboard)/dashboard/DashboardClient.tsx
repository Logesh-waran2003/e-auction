      ...
      case Role.SUPER_ADMIN:
        return (
          <div className='w-full'>
            ...
            >
              <div className='p- bg-blue-100/60 rounded-lg text-center shadow-md border border-blue-300'>
              ...
              <div className='p-4 bg-purple-100/60 rounded-lg text-center shadow-md border border-purple-300'>
